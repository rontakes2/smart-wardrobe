...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .msg-success { background: #f8fafc; color: #000000; border: 1px solid #000000; }
        .msg-error { background: #000000; color: #ffffff; }

        .admin-link-wrapper { margin-top: 24px; padding-top: 16px; border-top: 1px solid #e5e5e5; }
        .admin-link { color: #999; font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.1em; text-decoration: none; font-weight: 700; transition: color 0.2s; display: flex; align-items: center; justify-content: center; gap: 6px; }
        .admin-link:hover { color: #8b5cf6; } /* Purple hover hint for admin */
    </style>
</head>
<body>
